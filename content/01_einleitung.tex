...
A significant percentile of the particles measured in IceCube are muons, which are elementary particles categorized as leptons by the standard model. This 
they carry an electric charge of $\stackrel{+}{-}\num{1}e$ and have spin $\frac{1}{2}$. The mass of the muon is \num{105.658}\text{MeV}. IceCube detects
...
pions and kaons, aswell as their respective antiparticles. Due to their short lifetimes, they decay via beta decay almost immediately. 
