...
pions and kaons. % Their pion's lifetime is about \SI{2.60e-8}{s} for a charged $\pi⁺$ or $\pi⁻$ and around \SI{8.52e-17}{s} for the neutral $\pi⁰$. The 
% kaons lifetime is also of a similar magnitude, meaning both of these particles decay relatively quickly after being created. 
The average lifetime of these mesons are of the magnitude of \SI{e8}{s} or less. Their resulting decay products include muons which are produced via the 
